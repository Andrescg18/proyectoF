...
const CATALOG: Product[] = [
  // CAMISAS
  { id: 1, title: 'Camisa Slim Fit Blanca', price: 89900, description: 'Camisa de algodón premium corte slim fit, ideal para ocasiones formales e informales.', category: 'Camisas', image: 'https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=400&q=80', rating: { rate: 4.5, count: 210 } },
  { id: 2, title: 'Camisa Cuadros Flannel', price: 109900, description: 'Camisa de franela con estampado de cuadros, perfecta para looks casuales de temporada.', category: 'Camisas', image: 'https://images.unsplash.com/photo-1620012253295-c15cc3e65df4?w=400&q=80', rating: { rate: 4.3, count: 175 } },
  { id: 3, title: 'Camisa Lino Manga Larga', price: 129900, description: 'Camisa de lino transpirable, ideal para clima cálido. Corte relajado y elegante.', category: 'Camisas', image: 'https://images.unsplash.com/photo-1598033129183-c4f50c736f10?w=400&q=80', rating: { rate: 4.6, count: 198 } },
  { id: 4, title: 'Camisa Oxford Azul Marino', price: 99900, description: 'Camisa Oxford clásica en azul marino, combinable con cualquier pantalón.', category: 'Camisas', image: 'https://images.unsplash.com/photo-1607345366928-199ea26cfe3e?w=400&q=80', rating: { rate: 4.4, count: 143 } },
  { id: 5, title: 'Camisa Polo Clásica Negra', price: 79900, description: 'Polo de algodón peinado, cuello tejido y botones resistentes. Estilo atemporal.', category: 'Camisas', image: 'https://images.unsplash.com/photo-1591261730799-ee4e6c2d16d7?w=400&q=80', rating: { rate: 4.2, count: 220 } },
  ...
  { id: 8, title: 'Camiseta Oversize Negra', price: 64900, description: 'Camiseta oversize de tendencia, tela gruesa y duradera. Unisex.', category: 'Camisetas', image: 'https://images.unsplash.com/photo-1618354691373-d851c5c3a990?w=400&q=80', rating: { rate: 4.5, count: 275 } },
  { id: 9, title: 'Camiseta Tie Dye Multicolor', price: 54900, description: 'Camiseta de teñido anudado, cada pieza es única. Algodón 100%.', category: 'Camisetas', image: 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=400&q=80', rating: { rate: 4.0, count: 155 } },
  ...
  { id: 12, title: 'Pantalón Chino Beige', price: 139900, description: 'Chino de corte recto en gabardina beige. Elegante y cómodo para el día a día.', category: 'Pantalones', image: 'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=400&q=80', rating: { rate: 4.3, count: 214 } },
  ...
  { id: 14, title: 'Pantalón de Lino Gris', price: 159900, description: 'Pantalón de lino ligero para clima cálido. Corte relajado y estilo mediterráneo.', category: 'Pantalones', image: 'https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=400&q=80', rating: { rate: 4.2, count: 167 } },
  ...
  // PANTALONETAS
  { id: 16, title: 'Pantaloneta Deportiva Azul', price: 79900, description: 'Short deportivo con forro interior y bolsillos laterales. Ideal para correr o ir al gym.', category: 'Pantalonetas', image: 'https://images.unsplash.com/photo-1598128558393-70ff21433be0?w=400&q=80', rating: { rate: 4.5, count: 203 } },
  ...
  { id: 22, title: 'Tenis Casual Blanco', price: 229900, description: 'Tenis minimalista de cuero blanco con suela vulcanizada. Icono del estilo urbano.', category: 'Zapatos', image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&q=80', rating: { rate: 4.8, count: 512 } },
  ...
  { id: 25, title: 'Zapatillas Running Pro', price: 319900, description: 'Zapatillas para correr con amortiguación máxima y upper transpirable. Rendimiento elite.', category: 'Zapatos', image: 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=400&q=80', rating: { rate: 4.9, count: 437 } },
  ...
  { id: 28, title: 'Chaqueta Vaquera Azul', price: 249900, description: 'Chaqueta de denim con acabado stone-washed. Perfecta para looks casuales.', category: 'Chaquetas', image: 'https://images.unsplash.com/photo-1544441893-675973e31985?w=400&q=80', rating: { rate: 4.4, count: 212 } },
  { id: 29, title: 'Cortavientos Impermeable', price: 279900, description: 'Cortavientos ligero con membrana impermeable. Ideal para senderismo y deporte.', category: 'Chaquetas', image: 'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=400&q=80', rating: { rate: 4.6, count: 183 } },
  ...
  // ACCESORIOS
  { id: 31, title: 'Cinturón de Cuero Negro', price: 89900, description: 'Cinturón de cuero genuino con hebilla metálica plateada. Talla ajustable.', category: 'Accesorios', image: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400&q=80', rating: { rate: 4.4, count: 145 } },
  ...
  // CALZADO DEPORTIVO
  { id: 45, title: 'Tenis Basket High Top', price: 359900, description: 'Tenis de baloncesto con caña alta y sistema de amortiguación avanzado.', category: 'Zapatos', image: 'https://images.unsplash.com/photo-1607522370275-f6fd21709bb0?w=400&q=80', rating: { rate: 4.6, count: 312 } },
  { id: 46, title: 'Zapatillas Fútbol Sala', price: 289900, description: 'Zapatillas para fútbol sala con suela no marcadora y upper de malla.', category: 'Zapatos', image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&q=80', rating: { rate: 4.4, count: 198 } },
  ...
  { id: 48, title: 'Camisa Hawaiana Verano', price: 99900, description: 'Camisa estampada de verano en viscosa ligera. Estilo resort y vacacional.', category: 'Camisas', image: 'https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?w=400&q=80', rating: { rate: 4.2, count: 167 } },
